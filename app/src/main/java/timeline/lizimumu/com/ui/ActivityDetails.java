...
import timeline.lizimumu.com.util.BitmapUtil;
import timeline.lizimumu.com.util.SortEnum;
...
public class ActivityDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            Bitmap bitmap = BitmapUtil.drawableToBitmap(AppUtil.getPackageIcon(ActivityDetails.this, mPackageName));
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = getLayoutInflater().inflate(R.layout.detail_item_, parent, false);
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                try {
                    if (networkStatsManager != null) {
                        ...
                        if (ActivityCompat.checkSelfPermission(ActivityDetails.this, Manifest.permission.READ_PHONE_STATE) == PackageManager.PERMISSION_GRANTED) {
