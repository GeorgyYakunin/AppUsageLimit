...
import timeline.lizimumu.com.app.MyApplication;
...
import timeline.lizimumu.com.util.AppUtil;
...
public class ActivityMain extends AppCompatActivity {
    ...
    private void triggerSort() {
        mDialog = new AlertDialog.Builder(ActivityMain.this)
        ...
        if (!DataManager.getInstance().hasPermission(getApplicationContext())) {
            mSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                    if (b) {
                        Intent intent = new Intent(ActivityMain.this, AppService.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.settings:
                startActivityForResult(new Intent(ActivityMain.this, ActivitySettings.class), 1);
                return true;
            case R.id.sort:
                triggerSort();
                return true;
    ...
    class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_item_, parent, false);
        ...
        public void onBindViewHolder(MyViewHolder holder, int position) {
            ...
            GlideApp.with(ActivityMain.this)
                    .load(AppUtil.getPackageIcon(ActivityMain.this, item.mPackageName))
            ...
            void setOnClickListener(final AppItem item) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        intent.putExtra(ActivityDetails.EXTRA_PACKAGE_NAME, item.mPackageName);
                        intent.putExtra(ActivityDetails.EXTRA_DAY, mDay);
                        ActivityOptionsCompat options = ActivityOptionsCompat.
                                makeSceneTransitionAnimation(ActivityMain.this, mIcon, "profile");
