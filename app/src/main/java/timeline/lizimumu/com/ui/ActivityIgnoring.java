...
import timeline.lizimumu.com.data.IgnoreItem;
import timeline.lizimumu.com.db.DbIgnoreExecutor;
import timeline.lizimumu.com.util.AppUtil;

public class ActivityIgnoring extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_ignoring);
    ...
    class IgnoreAdapter extends RecyclerView.Adapter<IgnoreAdapter.IgnoreViewHolder> {
        ...
        public IgnoreViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = getLayoutInflater().inflate(R.layout.ignore_item_, parent, false);
            ...
            void setOnClickListener(final IgnoreItem item) {
                itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        new MyAsyncTask(ActivityIgnoring.this).execute();
                    }
                });
            }
        }
